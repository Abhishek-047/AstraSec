...
function InputField({ label, type="text", textarea=false }: { label:string; type?:string; textarea?:boolean }) {
  const inputStyle: React.CSSProperties = {
    width:"100%", backgroundColor:"rgba(201,168,76,0.04)",
    border:`1px solid #c9a84c`, color:"#f0f6ff",
    ...
    <div style={{ marginBottom:20 }}>
      ...
      {textarea ? (
        <textarea rows={4} style={inputStyle}
          onFocus={e=>{e.target.style.borderColor="#f0c96a"; e.target.style.boxShadow="0 0 8px rgba(201,168,76,0.35)"}}
          onBlur={e=>{e.target.style.borderColor="#c9a84c"; e.target.style.boxShadow="none"}}
        />
      ) : (
  ...
  return (
    <>
      ...
      <section style={{ width:"100%", padding:"0 24px", display:"flex", gap:40, flexWrap:"wrap", marginBottom:52, backgroundColor:"#0d1424", paddingTop:48, paddingBottom:52 }}>
        ...
        {/* Left - Contact Form */}
        <div style={{ flex:6, minWidth:280, backgroundColor:"#0f172a", border:`1px solid #c9a84c`, padding:"32px", position:"relative" }}>
          {/* Gold inner frame */}
          ...
          <div style={{ height:1, background:`linear-gradient(to right, #c9a84c, transparent)`, marginBottom:24 }}/>
          ...
          <form onSubmit={e=>e.preventDefault()}>
            ...
            <button style={{
              ...
              border:`1.5px solid #c9a84c`, color:"#c9a84c", backgroundColor:"rgba(201,168,76,0.08)",
              cursor:"pointer", transition:"all 0.2s ease", marginTop:10
            }}
            onMouseEnter={e=>{e.currentTarget.style.backgroundColor="rgba(201,168,76,0.18)";e.currentTarget.style.boxShadow="0 0 20px rgba(201,168,76,0.35)"}}
            onMouseLeave={e=>{e.currentTarget.style.backgroundColor="rgba(201,168,76,0.08)";e.currentTarget.style.boxShadow="none"}}
            >
              DISPATCH MESSAGE →
            </button>
          </form>
        ...
        <div style={{ flex:4, minWidth:260 }}>
          ...
          <div style={{ display:"flex", gap:12, alignItems:"flex-start", marginBottom:20, borderBottom:`1px solid #c9a84c`, paddingBottom:20 }}>
          ...
          <div style={{ display:"flex", gap:12, alignItems:"flex-start", marginBottom:32, borderBottom:`1px solid #c9a84c`, paddingBottom:20 }}>
          ...
          <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
            {[
              ...
              <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" style={{
                flex:1, minWidth:80, padding:"10px 0", backgroundColor:"rgba(201,168,76,0.06)", border:`1px solid #c9a84c`,
              ...
              onMouseEnter={e=>{e.currentTarget.style.backgroundColor="rgba(201,168,76,0.16)";e.currentTarget.style.boxShadow="0 0 12px rgba(201,168,76,0.25)"}}
              onMouseLeave={e=>{e.currentTarget.style.backgroundColor="rgba(201,168,76,0.06)";e.currentTarget.style.boxShadow="none"}}
              >
                {s.label}
              </a>
            ))}
